...
JNIEXPORT jlong JNICALL Java_com_kheafield_kenlm_KenLmClient_construct(
...
JNIEXPORT void JNICALL Java_com_kheafield_kenlm_KenLmClient_destroy(
    JNIEnv *env, jclass, jlong pointer) {
  delete reinterpret_cast<VirtualBase*>(pointer);
}

JNIEXPORT jlong JNICALL Java_com_kheafield_kenlm_KenLmClient_createPool(
...
JNIEXPORT void JNICALL Java_com_kheafield_kenlm_KenLmClient_destroyPool(
    JNIEnv *env, jclass, jlong pointer) {
  delete reinterpret_cast<Chart*>(pointer);
}

JNIEXPORT jint JNICALL Java_com_kheafield_kenlm_KenLmClient_order(
    JNIEnv *env, jclass, jlong pointer) {
  return reinterpret_cast<VirtualBase*>(pointer)->Order();
}

JNIEXPORT jboolean JNICALL Java_com_kheafield_kenlm_KenLmClient_registerWord(
...
JNIEXPORT jfloat JNICALL Java_com_kheafield_kenlm_KenLmClient_prob(
...
JNIEXPORT jfloat JNICALL Java_com_kheafield_kenlm_KenLmClient_probForString(
...
JNIEXPORT jboolean JNICALL Java_com_kheafield_kenlm_KenLmClient_isLmOov(
    JNIEnv *env, jclass, jlong pointer, jint word) {
    const VirtualBase* lm_base = reinterpret_cast<const VirtualBase*>(pointer);
    return lm_base->IsLmOov(word);
}

JNIEXPORT jboolean JNICALL Java_com_kheafield_kenlm_KenLmClient_isKnownWord(
...
JNIEXPORT jfloat JNICALL Java_com_kheafield_kenlm_KenLmClient_probString(
...
JNIEXPORT jlong JNICALL Java_com_kheafield_kenlm_KenLmClient_probRule(
...
JNIEXPORT jfloat JNICALL Java_com_kheafield_kenlm_KenLmClient_estimateRule(
